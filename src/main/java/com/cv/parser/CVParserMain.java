...
//	Table tableDirContent = new Table();
...
//	saveAsMenu.create();
	...
	new ReadFiles(null, filesInPublicDir, null, null).handleMenuItemClick();
	/* reading END **/
	...
	new ExtractFiles(shell, null, superList, null, null, null)
	.handleMenuItemClick();
	/* extracting END */
	...
	DocumentDetails dd = new DocumentDetails(null, null, superList);
